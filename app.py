...
def read_article(id):
    ...
    if is_premium_art and not is_premium_user:
        ...
        <div class="paywall-box">
            ...
            <p class="paywall-sub">Cet article est réservé aux membres Premium. Débloquez l'accès pour seulement <strong>655 F / mois</strong>.</p>
    ...
    <script>fetch('/vue/{art["id"]}', {{method:'POST'}});</script>
...
def premium():
    ...
    paydunya_btn_html = """
        <p style="color:#888;font-size:0.85rem;margin-bottom:1rem;">Paiement sécurisé par PayDunya 🔒</p>
